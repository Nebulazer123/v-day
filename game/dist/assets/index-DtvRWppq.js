...
`)}function kp(i,t){let e;switch(t){case Al:e="Linear";break;case Rl:e="Reinhard";break;case Cl:e="Cineon";break;case gc:e="ACESFilmic";break;case Dl:e="AgX";break;case Ll:e="Neutral";break;case Pl:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Ss=new T;function Bp(){Yt.getLuminanceCoefficients(Ss);const i=Ss.x.toFixed(4),t=Ss.y.toFixed(4),e=Ss.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Vp(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function ki(i){return i!==""}function Ka(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function $a(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Wp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Eo(i){return i.replace(Wp,jp)}const Xp=new Map;function jp(i,t){let e=Ht[t];if(e===void 0){const n=Xp.get(t);if(n!==void 0)e=Ht[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Eo(e)}const Yp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Za(i){return i.replace(Yp,qp)}function qp(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ja(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Kp(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===pc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===mc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===mn&&(t="SHADOWMAP_TYPE_VSM"),t}function $p(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case vi:case yi:t="ENVMAP_TYPE_CUBE";break;case ks:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Zp(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case yi:t="ENVMAP_MODE_REFRACTION";break}return t}function Jp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ao:t="ENVMAP_BLENDING_MULTIPLY";break;case wl:t="ENVMAP_BLENDING_MIX";break;case Tl:t="ENVMAP_BLENDING_ADD";break}return t}function Qp(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function tm(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=Kp(e),l=$p(e),h=Zp(e),d=Jp(e),u=Qp(e),p=Hp(e),g=Gp(r),_=s.createProgram();let m,f,E=e.glslVersion?"#version "+e.glslVersion+`
...
uniform float djGloss;`).replace("#include <opaque_fragment>",`
        ...
        #include <opaque_fragment>`)},t.customProgramCacheKey=()=>`dj-toon-${e}-${n}`,t}const oc=new Map;function At(i,t={}){const e=JSON.stringify([i,t]);let n=oc.get(e);return n||(n=$m({color:i,...t}),oc.set(e,n)),n}function _e(i,t=1.6){return At(i,{emissive:i,emissiveIntensity:t,rim:0})}const ac=i=>new T(i.x,i.y,i.z);function Zm(i){if(i.kind==="cylinder")return new fe(i.size.x/2,i.size.x/2,i.size.y,12);if(i.kind==="ramp"){const t=new Me,e=i.size.x/2,n=i.size.y,s=i.size.z/2,r=new Float32Array([-e,0,-s,e,0,-s,e,0,s,-e,0,-s,e,0,s,-e,0,s,-e,0,-s,-e,n,s,e,n,s,-e,0,-s,e,n,s,e,0,-s,-e,0,s,-e,n,s,e,n,s,-e,0,s,e,n,s,e,0,s,-e,0,-s,-e,0,s,-e,n,s,e,0,-s,e,n,s,e,0,s]);return t.setAttribute("position",new ze(r,3)),t.computeVertexNormals(),t}return new qt(i.size.x,i.size.y,i.size.z)}class jo{group=new kt;colliders=[];constructor(t){const e=new Map;for(const n of t.prims){if(!n.invisible){const s=Zm(n),r=new le().makeRotationY(n.yaw??0).setPosition(n.pos.x,n.pos.y+(n.kind==="ramp",0),n.pos.z);n.kind==="box"||n.kind,s.applyMatrix4(r);const o=JSON.stringify([n.color,n.emissive??0,n.emissiveIntensity??0]),a=e.get(o)??[];a.push(s),e.set(o,a)}n.ghost||this.colliders.push(this.makeCollider(n))}for(const[n,s]of e){const[r,o,a]=JSON.parse(n),c=Km(s,!1);if(!c)continue;const l=new tt(c,o?At(r,{emissive:o,emissiveIntensity:a}):At(r));l.castShadow=!0,l.receiveShadow=!0,this.group.add(l),s.forEach(h=>h.dispose())}}makeCollider(t){return t.kind==="ramp"?{kind:"ramp",center:ac(t.pos),half:new T(t.size.x/2,t.size.y,t.size.z/2),yaw:t.yaw??0,enabled:!0}:{kind:"box",center:ac({x:t.pos.x,y:t.pos.y,z:t.pos.z}),half:new T(t.size.x/2,t.size.y/2,t.size.z/2),yaw:t.yaw??0,enabled:!0}}addCollider(t){return this.colliders.push(t),t}groundAt(t,e,n){let s=-1/0;const r=new T;for(const o of this.colliders){if(!o.enabled||(r.set(t-o.center.x,0,e-o.center.z),o.yaw&&r.applyAxisAngle(Rr,-o.yaw),Math.abs(r.x)>o.half.x||Math.abs(r.z)>o.half.z))continue;let a;if(o.kind==="ramp"){const c=(r.z+o.half.z)/(o.half.z*2);a=o.center.y+c*o.half.y}else a=o.center.y+o.half.y;a<=n+.35&&a>s&&(s=a)}return s}resolveWalls(t,e,n){const s=new T;for(const r of this.colliders){if(!r.enabled||r.kind==="ramp")continue;const o=r.center.y+r.half.y,a=r.center.y-r.half.y;if(o<t.y+.3||a>t.y+n)continue;s.set(t.x-r.center.x,0,t.z-r.center.z),r.yaw&&s.applyAxisAngle(Rr,-r.yaw);const c=r.half.x+e-Math.abs(s.x),l=r.half.z+e-Math.abs(s.z);c<=0||l<=0||(c<l?s.x+=c*Math.sign(s.x||1):s.z+=l*Math.sign(s.z||1),r.yaw&&s.applyAxisAngle(Rr,r.yaw),t.x=r.center.x+s.x,t.z=r.center.z+s.z)}}}const Rr=new T(0,1,0);function re(i,t,e,n,s={}){const r=new tt(new qt(i,t,e),At(n,s));return r.castShadow=!0,r.receiveShadow=!0,r}function Yn(i,t,e,n,s=10,r={}){const o=new tt(new fe(i,t,e,s),At(n,r));return o.castShadow=!0,o.receiveShadow=!0,o}function Ls(i,t,e=10,n={}){const s=new tt(new be(i,e,Math.max(6,e-2)),At(t,n));return s.castShadow=!0,s.receiveShadow=!0,s}function Yo(i,t,e){const n=document.createElement("canvas");n.width=i,n.height=t;const s=n.getContext("2d");e(s);const r=new kc(n);return r.anisotropy=4,r}function Jm(){const i=new kt,t=new kt,e=re(.62,.42,.95,O.bentley);e.position.y=.42,t.add(e);const n=re(.56,.34,.3,O.bentley);n.position.set(0,.38,.45),t.add(n);const s=new kt;s.position.set(0,.72,.55);const r=re(.46,.4,.42,O.bentley);s.add(r);const o=re(.26,.2,.24,O.bentleyEar);o.position.set(0,-.08,.3),s.add(o);const a=re(.1,.08,.06,2234900);a.position.set(0,-.03,.44),s.add(a);for(const g of[-1,1]){const _=Ls(.045,1577484,8);_.position.set(.12*g,.08,.22),s.add(_)}const c=g=>{const _=new kt;_.position.set(.2*g,.18,-.02);const m=re(.1,.62,.3,O.bentleyEar);return m.position.y=-.28,_.add(m),_.rotation.z=.5*g,s.add(_),_},l=c(1),h=c(-1);t.add(s);const d=[];for(const[g,_]of[[-.22,.32],[.22,.32],[-.22,-.34],[.22,-.34]]){const m=new kt;m.position.set(g,.24,_);const f=re(.14,.34,.16,O.bentley);f.position.y=-.14,m.add(f),t.add(m),d.push(m)}const u=new kt;u.position.set(0,.55,-.48);const p=re(.09,.09,.34,O.bentleyEar);return p.position.z=-.15,u.add(p),u.rotation.x=-.7,t.add(u),i.add(t),{group:i,earL:l,earR:h,tail:u,head:s,body:t,legs:d}}function Qm(){const i=new kt,t={gloss:.85,rim:.35,flatShading:!1,emissive:4851720,emissiveIntensity:1},e=re(1.76,.42,4.1,O.victoryRed,t);e.position.y=.5,i.add(e);const n=new tt(new fe(.62,.86,1.5,4,1),At(O.victoryRed,t));n.geometry.rotateY(Math.PI/4),n.geometry.scale(1.42,1,.5),n.rotation.x=Math.PI/2,n.position.set(0,.48,2.5),n.castShadow=!0,i.add(n);const s={gloss:.75,rim:.45,flatShading:!1},r=re(1.28,.05,.78,1383728,s);r.rotation.x=-.62,r.position.set(0,.86,.28),i.add(r);const o=re(1.24,.05,.72,1383728,s);o.position.set(0,1.02,-.42),i.add(o);const a=re(1.24,.05,.62,1383728,s);a.rotation.x=.72,a.position.set(0,.88,-1.02),i.add(a);const c=re(1.18,.3,1.36,1383728,s);c.position.set(0,.78,-.42),i.add(c);const l=re(1.7,.16,.7,O.victoryRed,t);l.position.set(0,.66,-1.85),i.add(l);const h=re(1.5,.06,.18,O.victoryRed,t);h.position.set(0,.78,-2.08),i.add(h);const d=re(1.72,.34,.06,1707794,{gloss:.3,flatShading:!1});d.position.set(0,.55,-2.13),i.add(d);const u=[];for(const f of[-.64,-.3,.3,.64]){const E=new tt(new fe(.115,.115,.03,14),At(853769,{flatShading:!1}));E.rotation.x=Math.PI/2,E.position.set(f,.55,-2.16),i.add(E);const b=new tt(new fe(.085,.085,.03,14),_e(O.taillight,1.7));b.rotation.x=Math.PI/2,b.position.set(f,.55,-2.17),i.add(b),u.push(b)}for(const f of[-.24,-.1,.1,.24]){const E=Yn(.05,.05,.12,13159894,10,{gloss:.5,flatShading:!1});E.rotation.x=Math.PI/2,E.position.set(f,.3,-2.1),i.add(E)}const p=[];for(const f of[-.55,.55]){const E=re(.3,.09,.06,O.star,{emissive:O.star,emissiveIntensity:1.2});E.position.set(f,.56,2.94),i.add(E);const b=new Gc(16773836,0,40,.5,.45,1.2);b.position.set(f,.6,2.9),b.target.position.set(f*1.2,0,14),i.add(b,b.target),p.push(b)}const g=[];for(const[f,E]of[[-.85,1.55],[.85,1.55],[-.85,-1.45],[.85,-1.45]]){const b=new kt,M=Yn(.36,.36,.26,1053471,14,{rim:.1,flatShading:!1});M.rotation.z=Math.PI/2,b.add(M);const C=Yn(.18,.18,.28,13159894,8,{gloss:.6,flatShading:!1});C.rotation.z=Math.PI/2,b.add(C),b.position.set(f,.36,E),i.add(b),g.push(b)}const _=Yo(128,64,f=>{f.fillStyle="#e8e4d8",f.fillRect(0,0,128,64),f.fillStyle="#14224A",f.font='bold 34px "Space Grotesk", sans-serif',f.textAlign="center",f.textBaseline="middle",f.fillText("LAINIE",64,36)}),m=new tt(new cn(.44,.22),new bi({map:_}));return m.position.set(0,.32,-2.145),m.rotation.y=Math.PI,i.add(m),{group:i,wheels:g,headlights:p,taillights:u}}function Ti(i=O.duck){const t=new kt,e=Ls(.22,i,10);e.scale.set(1,.85,1.25),e.position.y=.24,t.add(e);const n=new kt;n.position.set(0,.5,.14);const s=Ls(.13,i,10);n.add(s);const r=re(.12,.05,.14,O.duckBill);r.position.set(0,-.02,.15),n.add(r);for(const a of[-1,1]){const c=Ls(.025,1577484,6);c.position.set(.07*a,.05,.09),n.add(c)}t.add(n);const o=a=>{const c=new kt;c.position.set(.2*a,.28,0);const l=re(.06,.16,.3,i);return l.position.y=-.06,c.add(l),t.add(c),c};return{group:t,head:n,wingL:o(1),wingR:o(-1)}}function cc(){const i=new kt,t=Yn(.06,.09,5.4,2765650,8);t.position.y=2.7,i.add(t);const e=re(.1,.08,1.6,2765650);e.position.set(0,5.3,.7),i.add(e);const n=re(.24,.1,.5,O.ramenGold,{emissive:O.ramenGold,emissiveIntensity:1.8});return n.position.set(0,5.22,1.35),i.add(n),i}function t0(i){const t=new kt,e=re(.08,.3,i,5857663,{gloss:.25,flatShading:!1});e.position.y=.62,t.add(e);const n=Math.max(2,Math.round(i/2.4));for(let s=0;s<n;s++){const r=re(.1,.62,.12,3818600);r.position.set(0,.31,-i/2+(s+.5)*(i/n)),t.add(r)}return t}function $c(i=4,t=O.pine){const e=new kt,n=Yn(.1,.16,i*.3,3811870,7);n.position.y=i*.15,e.add(n);let s=i*.28,r=i*.24;for(let o=0;o<3;o++){const a=new tt(new Oo(r,i*.32,8),At(t));a.castShadow=!0,a.position.y=s+i*.14,e.add(a),s+=i*.22,r*=.72}return e}function Os(i,t={}){const e=t.w??3,n=t.h??1.4,s=Yo(512,Math.round(512*n/e),c=>{const l=c.canvas.height;c.fillStyle=t.bg??"#14224A",c.fillRect(0,0,512,l),c.strokeStyle=t.fg??"#FF4D8D",c.lineWidth=8,c.strokeRect(10,10,492,l-20),c.fillStyle=t.fg??"#FF4D8D",c.textAlign="center",c.textBaseline="middle";const h=Math.min(54,(l-40)/i.length-6);c.font=`700 ${h}px "Space Grotesk", sans-serif`,i.forEach((d,u)=>{c.fillText(d,256,l/(i.length+1)*(u+1)+4)})}),r=new kt,o=new tt(new cn(e,n),new Qe({map:s}));o.position.y=2.2,r.add(o);const a=new Dn(t.glow??O.heartNeon,6,6);a.position.set(0,2.2,.4),r.add(a);for(const c of[-1,1]){const l=Yn(.05,.05,2.2,2765650,6);l.position.set((e/2-.2)*c,1.1,0),r.add(l)}return r}function e0(i,t=1.1){const e=new kt,n=re(t,t*1.16,.04,16118504,{rim:.1,flatShading:!1});e.add(n);const s=new kh().load(i);s.colorSpace=Fe;const r=new tt(new cn(t*.86,t*.86),new Qe({map:s}));return r.position.set(0,t*.07,.025),e.add(r),e}function qo(){const i=new kt,t=re(.5,.02,.6,16118504,{rim:.05});t.rotation.z=.08,i.add(t);const e=Yn(.09,.09,.05,O.heartNeon,12,{emissive:O.heartNeon,emissiveIntensity:1.4});return e.position.y=.04,i.add(e),i}function Zc(){const i=Ti(O.ramenGold);return i.group.traverse(t=>{t instanceof tt&&t.material instanceof bi&&(t.material=At(O.ramenGold,{emissive:O.ramenGold,emissiveIntensity:.5,gloss:.7,flatShading:!1}))}),i.group}const n0={walkSpeed:5.2,accel:42,friction:26,gravity:24,jumpVel:8.6,jumpCutMultiplier:2.6,coyoteTime:.12,jumpBuffer:.15,pounceSpeed:11.5,pounceTime:.28,pounceCooldown:.9,maxFall:22,speedMultiplier:1};function i0(){return{vx:0,vy:0,vz:0,grounded:!1,coyote:0,buffer:0,pouncing:0,pounceCd:0,jumpHeld:!1,facingX:0,facingZ:1,justJumped:!1,justLanded:!1,justPounced:!1}}function s0(i,t,e,n,s,r){i.justJumped=!1,i.justLanded=!1,i.justPounced=!1;const o=i.grounded,a=s<=r+.02&&i.vy<=.001&&r>-1/0;if(i.grounded=a,a?(i.coyote=e.coyoteTime,o||(i.justLanded=!0)):i.coyote=Math.max(0,i.coyote-n),i.buffer=t.jumpPressed?e.jumpBuffer:Math.max(0,i.buffer-n),i.pounceCd=Math.max(0,i.pounceCd-n),t.pounce&&i.pounceCd<=0&&i.pouncing<=0){const l=Math.hypot(t.x,t.y),h=l>.15?t.x/l:i.facingX,d=l>.15?t.y/l:i.facingZ;i.vx=h*e.pounceSpeed*e.speedMultiplier,i.vz=d*e.pounceSpeed*e.speedMultiplier,a?i.vy=2.2:i.vy=Math.max(i.vy,2.2),i.pouncing=e.pounceTime,i.pounceCd=e.pounceCooldown,i.grounded=!1,i.justPounced=!0}if(i.pouncing>0)i.pouncing-=n,i.vy-=e.gravity*.55*n;else{const l=e.walkSpeed*e.speedMultiplier,h=Math.hypot(t.x,t.y);if(h>.05){const p=t.x/Math.max(h,1),g=t.y/Math.max(h,1);i.vx=bs(i.vx,p*l*Math.min(h,1),e.accel*n),i.vz=bs(i.vz,g*l*Math.min(h,1),e.accel*n),i.facingX=p,i.facingZ=g}else i.vx=bs(i.vx,0,e.friction*n),i.vz=bs(i.vz,0,e.friction*n);i.buffer>0&&(i.grounded||i.coyote>0)&&(i.vy=e.jumpVel,i.buffer=0,i.coyote=0,i.grounded=!1,i.justJumped=!0);const u=i.vy>0&&!t.jumpHeld?e.gravity*e.jumpCutMultiplier:e.gravity;i.grounded?i.vy=Math.max(0,i.vy):i.vy=Math.max(-e.maxFall,i.vy-u*n)}let c=i.vy*n;return i.vy<=0&&r>-1/0&&s+c<=r&&(c=r-s,i.vy=0),{dx:i.vx*n,dy:c,dz:i.vz*n}}function bs(i,t,e){return i<t?Math.min(t,i+e):Math.max(t,i-e)}class Ko{rig;pos=new T;state=i0();cfg={...n0};radius=.34;height=.9;squash=0;t=0;events={jumped:!1,landed:!1,pounced:!1};constructor(){this.rig=Jm()}applyCosmetics(t,e){const n=this.rig.head;if(t.includes("cap")){const s=new tt(new fe(.26,.28,.14,10),At(O.victoryRed,{flatShading:!1}));s.position.set(0,.26,-.02);const r=new tt(new qt(.3,.04,.24),At(O.victoryRed,{flatShading:!1}));r.position.set(0,.22,-.3),n.add(s,r)}if(t.includes("sunglasses")){const s=new tt(new qt(.4,.09,.05),At(592402,{gloss:.9,flatShading:!1}));s.position.set(0,.08,.24),n.add(s)}if(t.includes("glasses"))for(const s of[-1,1]){const r=new tt(new an(.07,.015,6,12),At(13159894,{gloss:.6,flatShading:!1}));r.position.set(.12*s,.08,.25),n.add(r)}if(t.includes("bandana")){const s=new tt(new fe(.3,.34,.16,8),At(O.taroPurple,{flatShading:!1}));s.position.set(0,-.22,0),n.add(s)}if(t.includes("crown")){const s=new tt(new fe(.2,.24,.18,8),At(O.ramenGold,{emissive:O.ramenGold,emissiveIntensity:.6,gloss:.9,flatShading:!1}));s.position.set(0,.32,0),n.add(s)}if(e){const s=new tt(new an(.24,.03,8,18),At(O.star,{emissive:O.star,emissiveIntensity:1.6}));s.rotation.x=Math.PI/2,s.position.set(0,.48,0),n.add(s)}this.trail=t.includes("trailHearts")?O.heartNeon:t.includes("trailStars")?O.star:null}trail=null;spawnAt(t,e,n,s=0){this.pos.set(t,e,n),this.state.vx=this.state.vy=this.state.vz=0,this.state.facingX=Math.sin(s),this.state.facingZ=Math.cos(s),this.rig.group.position.copy(this.pos)}update(t,e,n,s){const r=Math.cos(s),o=Math.sin(s),a=e.moveX*r-e.moveY*o,c=-e.moveX*o-e.moveY*r,l=n.groundAt(this.pos.x,this.pos.z,this.pos.y+.3),h=s0(this.state,{x:a,y:c,jumpPressed:e.jumpPressed,jumpHeld:e.jump,pounce:e.pounce},this.cfg,t,this.pos.y,l);this.pos.x+=h.dx,this.pos.y+=h.dy,this.pos.z+=h.dz,n.resolveWalls(this.pos,this.radius,this.height),this.events={jumped:this.state.justJumped,landed:this.state.justLanded,pounced:this.state.justPounced},this.t+=t;const d=this.rig.group;d.position.copy(this.pos);const u=Math.hypot(this.state.vx,this.state.vz);if(u>.4){const E=Math.atan2(this.state.facingX,this.state.facingZ);d.rotation.y=r0(d.rotation.y,E,14,t)}this.state.justLanded&&(this.squash=1),(this.state.justJumped||this.state.justPounced)&&(this.squash=-.7),this.squash=lc(this.squash,0,9,t);const p=1-this.squash*.25,g=1+this.squash*.18;this.rig.body.scale.set(g,p,g);const _=Math.min(1,u/this.cfg.walkSpeed),m=this.t*13;this.rig.legs.forEach((E,b)=>{const M=b%2===0?0:Math.PI;E.rotation.x=Math.sin(m+M)*.7*_});const f=-this.state.vy*.05+Math.sin(m)*.12*_;this.rig.earL.rotation.z=.5+f,this.rig.earR.rotation.z=-.5-f,this.rig.earL.rotation.x=this.state.grounded?0:-.6,this.rig.earR.rotation.x=this.state.grounded?0:-.6,this.rig.tail.rotation.x=-.7+Math.sin(this.t*8)*.25*(.4+_),this.rig.body.rotation.x=this.state.pouncing>0?-.35:lc(this.rig.body.rotation.x,0,10,t)}}function lc(i,t,e,n){return de.damp(i,t,e,n)}function r0(i,t,e,n){let s=(t-i)%(Math.PI*2);return s>Math.PI&&(s-=Math.PI*2),s<-Math.PI&&(s+=Math.PI*2),i+s*(1-Math.exp(-14*n))}class Jc{rig;state={z:0,x:0,speed:0,driving:!1};maxSpeed=26;laneHalf=5.4;speedMultiplier=1;constructor(){this.rig=Qm()}place(t,e,n=0){this.state.x=t,this.state.z=e,this.rig.group.position.set(t,0,e),this.rig.group.rotation.y=n}setHeadlights(t){for(const e of this.rig.headlights)e.intensity=t?260:0}update(t,e,n){const s=this.state,r=n*this.maxSpeed*this.speedMultiplier;s.speed=de.damp(s.speed,r,1.6,t),s.z+=s.speed*t,s.x+=e*9*t*Math.min(1,Math.abs(s.speed)/6+.2),s.x=de.clamp(s.x,-this.laneHalf,this.laneHalf);const o=this.rig.group;o.position.set(s.x,0,s.z),o.rotation.y=e*-.18*Math.sign(s.speed||1);const a=s.speed*t*2.6;for(const c of this.rig.wheels)c.rotation.x+=a;o.rotation.z=de.damp(o.rotation.z,e*-.06,6,t)}}const o0=`
  varying vec3 vWorld;
  void main() {
